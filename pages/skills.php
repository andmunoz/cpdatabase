...
<div class="row">
    <div class="col s12 m12 l12 right-align">
        ...
        <a href="includes/import.php?format=json&data=Habilidades" target="_blank" class="waves-effect red waves-light btn"><i class="material-icons left">cloud_upload</i>Importar CSV</a>
    </div>
</div>
<div class="row">
    <div class="col s12 m12 l12">
